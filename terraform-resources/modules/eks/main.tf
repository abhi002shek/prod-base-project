...
# EKS Node Group - Frontend
resource "aws_eks_node_group" "frontend" {
  cluster_name    = aws_eks_cluster.main.name
  node_group_name = "${var.cluster_name}-frontend-ng"
  node_role_arn   = aws_iam_role.node_group.arn
  subnet_ids      = var.frontend_subnet_ids
  version         = var.cluster_version

  scaling_config {
    desired_size = var.frontend_desired_size
  ...
  instance_types = var.frontend_instance_types
  ...
  tags = merge(var.tags, {
    Name = "${var.cluster_name}-frontend-node-group"
  })
...
# EKS Node Group - Backend
resource "aws_eks_node_group" "backend" {
  cluster_name    = aws_eks_cluster.main.name
  node_group_name = "${var.cluster_name}-backend-ng"
  node_role_arn   = aws_iam_role.node_group.arn
  ...
  tags = merge(var.tags, {
    Name = "${var.cluster_name}-backend-node-group"
  })
